            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                                ...
                                echo "<td>".'<a id="edit-pet" class="btn btn-warning" href="admin_edit_pet.php?pet_id='.$row['pet_id'].'">แก้ไข</a>'."</td>";
                                echo "<td>".'<a id="del-pet" class="btn btn-danger" href="admin_delete_pet.php?pet_id='.$row['pet_id'].'">ลบ</a>'."</td>";
                                echo "</tr>";
                            }
