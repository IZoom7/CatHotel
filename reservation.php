...
if (isset($_SESSION['username'])) {
    ...
    $sql = "SELECT * FROM pets WHERE owner_id = (SELECT owner_id from owner where owner_username = '$username') UNION SELECT owner_username FROM owner WHERE owner_username = '$username";
